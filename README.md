# Personal Page made by Double D
- Book Review
- Sound Review
...
For use this in the [_config.yml](https://github.com/gdg-managua/jekyll-mdl/blob/master/_config.yml) select the type of layout, rebuild the website and voila :smile:
...
Copyright ¨Ï 2015 [Google Developers Group Managua](http://www.gdgmanagua.org).
